...
```bash
git add src/components/HistorySkeleton.tsx src/components/UsageHistoryView.tsx src/components/UsageHistoryView.test.tsx
...
`timeStr`(19-21행)과 갱신 시각 span(38행)을 교체:
